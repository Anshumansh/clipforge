...
Invoked as a plain subprocess (see lib/providers/voice-clone.ts) rather than
kept as a long-running process — the model only occupies memory for the
duration of one synthesis, not 24/7 on an already resource-constrained VPS.
